/*!
 * Site: Front-end site library
 * @license MIT
 * Inline scripts may access the api using an async handler:
 *   var SiteEditor = SiteEditor || [];
 *   SiteEditor.push(readyFunction);
 */
! function (t) {
    var e = {};
    ...
    d.config.hideBackface = !1, d.config.keepInherited = !0, r.define = function (t, e, n) {
        ...
        var e = window.__wf_design,
            n = void 0 !== e;
        return t ? "design" === t ? n && e : "preview" === t ? n && !e : "slug" === t ? n && window.__wf_slug : "editor" === t ? window.SiteEditorEditor : "test" === t ? window.__wf_test : "frame" === t ? window !== window.top : void 0 : n
    };
    ...
    var T, O = "resize.siteEditor orientationchange.siteEditor load.siteEditor";
    ...
    r.resize = b(c, O), r.scroll = b(c, "scroll.siteEditor resize.siteEditor orientationchange.siteEditor load.siteEditor"), r.redraw = b(), r.location = function (t) {
        window.location = t
    ...
    }, u(r.ready), A(), t.exports = window.SiteEditor = r
}, function (t, e) {
    t.exports = function (t) {
        var e = typeof t;
    ...
    n(122), n(124), n(36), n(125), n(66), n(126), n(314), n(315), n(316), n(317), t.exports = n(322)
}, function (t, e, n) {
    "use strict";
    var r = n(5);
    r.define("brand", t.exports = function (t) {
        ...
        return n.ready = function () {
            ...
            /\.siteEditor\.io$/i.test(p) && c.hostname !== p && (u = !0), u && !s && (e = e || (n = t('<a class="w-siteEditor-badge"></a>').attr("href", "https://siteEditor.com?utm_campaign=brandjs"), r = t("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/siteEditor-badge-icon.f67cd735e3.svg").attr("alt", "").css({
                marginRight: "8px",
                width: "16px"
            }), a = t("<img>").attr("src", "https://d1otoma47x30pg.cloudfront.net/img/siteEditor-badge-text.6faa6a38cd.svg").attr("alt", "Made in SiteEditor"), n.append(r, a), n[0]), d(), setTimeout(d, 500), t(i).off(f, l).on(f, l))
        }, n
    })
}, function (t, e, n) {
    "use strict";
    var r = window.$,
        i = n(65) && r.tram;
    /*!
     * SiteEditor._ (aka) Underscore.js 1.6.0 (custom build)
     * _.each
     * _.map
     * _.find
     * _.filter
    ...
    r.define("edit", t.exports = function (t, e, n) {
        ...
        var i, o = t(window),
            ...
            c = "hashchange",
            s = n.load || function () {
                i = !0, window.SiteEditorEditor = !0, o.off(c, l),
                    function (t) {
                        var e = window.document.createElement("iframe");
                        e.src = "https://siteEditor.com/site/third-party-cookie-check.html", e.style.display = "none", e.sandbox = "allow-scripts allow-same-origin";
                        var n = function n(r) {
                        ...
                        t.ajax({
                            url: E("https://editor-api.siteEditor.com/api/editor/view"),
                            data: {
            ...
            f = !1;
        try {
            f = localStorage && localStorage.getItem && localStorage.getItem("SiteEditorEditor")
        } catch (t) {}
        ...
        function h(t) {
            return t.indexOf("//") >= 0 ? t : E("https://editor-api.siteEditor.com" + t)
        }
    ...
    e.createPluginInstance = function (t) {
        var e = window.SiteEditor.require("lottie").createInstance(t);
    ...
    e.clearPlugin = function (t) {
        window.SiteEditor.require("lottie").createInstance(t).stop()
    }
}, function (t, e, n) {
    "use strict";
    var r, i, o, a = n(0),
    ...
    i.define("forms", t.exports = function (t, e) {
        ...
        return s.ready = s.design = s.preview = function () {
            ! function () {
                o = t("html").attr("data-wf-site"), u = "https://siteEditor.com/api/v1/form/" + o, d && u.indexOf("https://siteEditor.com") >= 0 && (u = u.replace("https://siteEditor.com", "http://formdata.siteEditor.com"));
...
/**
 * ----------------------------------------------------------------------
 * SiteEditor: Interactions: Init
 */
SiteEditor.require('ix').init([
    {
        "slug": "display-video-player-on-overlay",
        "name": "Display video player on overlay",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
    ...
    {
        "slug": "close-overlay-video",
        "name": "Close overlay video",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
    ...
    {
        "slug": "slide-up-email-on-load",
        "name": "Slide up email on load",
        "value": {
            "style": {
                "opacity": 0.6000000000000002,
                "x": "0px",
                "y": "100px",
                "z": "0px"
            },
            "triggers": [{
                ...
                "stepsA": [{
                    "wait": "100ms",
                    "opacity": 1,
                    "transition": "transform 600ms ease 0, opacity 600ms ease 0",
                    "x": "0px",
                    "y": "0px",
                    "z": "0px"
                }],
    ...
    {
        "slug": "badge-appears-on-load",
        "name": "Badge appears on load",
        "value": {
            "style": {
                "opacity": 0,
                "scaleX": 0.4,
            ...
            "triggers": [{
                ...
                "stepsA": [{
                    "opacity": 1,
                    "transition": "transform 1200ms ease 0, opacity 200 ease 0",
                    "scaleX": 1,
                    "scaleY": 1,
                    "scaleZ": 1,
                    "rotateX": "0deg",
        ...
        "value": {
            ...
            "triggers": [{
                ...
                "stepsA": [{
                    ...
                    "scaleX": 0.9400000000000002,
                    "scaleY": 0.9400000000000002,
                    "scaleZ": 1
                }, {
                    "transition": "transform 3000ms ease 0",
                    "scaleX": 1,
    ...
    {
        "slug": "open-close-collapsed-form",
        "name": "Open/Close collapsed form",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
                "selector": ".collapsed-form",
                "stepsA": [{
                    "display": "block"
                }],
                "stepsB": [{
                ...
                "type": "click",
                "selector": ".form--action__arrow--top",
                "preserve3d": true,
                "stepsA": [{
                    "rotateX": "0deg",
                    "rotateY": "0deg",
                ...
                "type": "click",
                "selector": ".form--action__arrow--bottom",
                "preserve3d": true,
                "stepsA": [{
                    "rotateX": "0deg",
                    "rotateY": "0deg",
...
/**
 * ----------------------------------------------------------------------
 * SiteEditor: Interactions 2.0: Init
 */
SiteEditor.require('ix2').init({
    "events": {
        "e-5": {
            "id": "e-5",
            "name": "",
        ...
        "e-44": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5f326ba144764e15ec29bcd6|cae55366-5bb9-41d1-93c8-d2a660c2b7ad",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-45": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "5f326ba144764e15ec29bcd6|cae55366-5bb9-41d1-93c8-d2a660c2b7d3",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-52": {
            ...
            "createdOn": 1610379899847
        }
    },
    "actionLists": {
        "a-4": {
            "id": "a-4",
            "title": "Focus button moves with page 3",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-4-n",
                    ...
                    "config": {
                        ...
                        "duration": 10000,
                        "target": {
                            "id": "5f326ba144764e10bf29bcdf|06a856e3-b035-b466-0b3e-6241fab40eee"
                        },
                        "yValue": 20,
                        "xUnit": "PX",
                        "yUnit": "PX",
            ...
            "createdOn": 1520346351803
        },
        "a-20": {
            "id": "a-20",
            "title": "Focus button moves with page 11",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-20-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    "config": {
                        ...
                        "duration": 10000,
                        "target": {
                            "id": "5f326ba144764e342c29bce7|06a856e3-b035-b466-0b3e-6241fab40eee"
                        },
                        "yValue": 20,
                        "xUnit": "PX",
                        "yUnit": "PX",
        ...
        "a-22": {
                ...
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "5f326ba144764e15ec29bcd6|5aa1d128-47a3-1be7-9234-78386d144944"
                            },
                            "value": 0.75,
                            "unit": ""
                        }
            ...
            "createdOn": 1520365108802
        },
        "a-23": {
            "id": "a-23",
            "title": "Scroll demo up 3",
            "continuousParameterGroups": [{
                "id": "a-23-p",
                "type": "SCROLL_PROGRESS",
                "parameterLabel": "Scroll",
                "continuousActionGroups": [{
                    ...
                    "actionItems": [{
                        ...
                        "config": {
                            ...
                            "duration": 500,
                            "target": {
                                "id": "5f326ba144764e15ec29bcd6|ad38f614-6afb-38cd-d037-bf617f918201"
                            },
                            "yValue": 150,
                            "xUnit": "PX",
                            "yUnit": "PX",
        ...
        "a-24": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 10000,
                        "target": {
                            "id": "5f326ba144764e15ec29bcd6|000e1c5d-36a7-accd-cd43-d91b47c456e9"
                        },
                        "zValue": 0,
                        "xUnit": "DEG",
                        "yUnit": "DEG",
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1596447701113
        },
        "a-25": {
            "id": "a-25",
            "title": "Interface disappear 3.0",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-25-n",
                    "actionTypeId": "STYLE_OPACITY",
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5f326ba144764e15ec29bcd6|3b269ff3-a8da-d62e-1045-92b57a1c58ec"
                        },
                        "value": 1,
                        "unit": ""
                    }
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "5f326ba144764e15ec29bcd6|41c18f67-f97c-0d69-2a4e-a8e829b4ba12"
                        },
                        "value": 1,
                        "unit": ""
                    }
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1596528367781
        },
        "a-26": {
            "id": "a-26",
            "title": "Focus button moves with page 12",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-26-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    "config": {
                        ...
                        "duration": 10000,
                        "target": {
                            "id": "5f5f8466920a0ab4d181441f|06a856e3-b035-b466-0b3e-6241fab40eee"
                        },
                        "yValue": 20,
                        "xUnit": "PX",
                        "yUnit": "PX",
        ...
        "a-27": {
            "id": "a-27",
            "title": "Focus button moves with page 13",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-27-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                    "config": {
                        ...
                        "duration": 10000,
                        "target": {
                            "id": "5ffc727b0ecd0bce26a0a75b|06a856e3-b035-b466-0b3e-6241fab40eee"
                        },
                        "yValue": 20,
                        "xUnit": "PX",
                        "yUnit": "PX",
